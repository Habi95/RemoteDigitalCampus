...
public class RestaurantRepo implements Repository<Restaurant> {
    ...
    public ArrayList<Restaurant> findAll() {
        ArrayList<Restaurant> users = new ArrayList<>();
        ...
        try {
            while (result.next()) {
                ...
                users.add(new Restaurant(ID , name, email , password ,place,type));
    ...
    public Restaurant findOne(int id){
        ...
        try {
            while (result.next()) {
                ...
                resultUser = new Restaurant(ID , name, email , password ,place , type);
            }
        } catch (SQLException e) {
            e.printStackTrace();
            output.outPutStringLanding(e.getMessage());
    ...
    public Restaurant findWithEmail (String email) {
        Restaurant resultUser = null;
        ...
        try {
            while (result.next()) {
                ...
                resultUser = new Restaurant(ID , name, email1 , password ,place,type);
